    ...
    <div className="App">
      <div className="flex items-center justify-center min-h-screen body-bg">
        <div className="relative">
          <ul className="relative flex max-w-3xl px-3 mx-auto mt-16 overflow-hidden rounded-t-lg sm:px-5 md:px-8 lg:px-0 h-96 w-600">
        ...
        <div className="absolute flex flex-row-reverse items-center right-8 bottom-20">
          <button
            className="p-4 font-mono text-2xl font-bold capitalize transition-opacity duration-500 rounded-full bg-cyan-500 text-gray-50 focus:outline-none hover:opacity-90"
